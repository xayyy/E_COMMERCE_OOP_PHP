...
<link type="text/css" href="./admin/css2/bootstrap.min.css" rel="stylesheet"/>
...
if ($login == false) {
    ?>
    <a class="btn btn-primary" style="margin-right:40px;" href="login.php">Login User</a>
<?php
} else {
        ?>
<a class="btn btn-primary" style="margin-right:40px;" href="?cid=<?php Session::get('cmrId'); ?>">Logout User</a>
<?php
    }
 ?>
 <a href="./admin/login.php" class="btn btn-danger" style="margin-top: -85px; margin-right:-150px;">Admin</a>
